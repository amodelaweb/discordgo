...
* Read the reference docs on [Godoc](https://godoc.org/github.com/amodelaweb/discordgo) or [GoWalker](https://gowalker.org/github.com/amodelaweb/discordgo)
* Try the [examples](https://github.com/amodelaweb/discordgo/tree/master/examples)
* Explore [Awesome DiscordGo](https://github.com/amodelaweb/discordgo/wiki/Awesome-DiscordGo)
